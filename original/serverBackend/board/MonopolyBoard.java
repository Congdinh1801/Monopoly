...
public class MonopolyBoard {
	...
	private void initializeSquares() {
		...
		assetCollections.add(fiumicino);
		...
		assetCollections.add(mortorway);
		...
		assetCollections.add(barcelona);
		...
		assetCollections.add(amsterdam);
		...
		assetCollections.add(stockholm);
		...
		assetCollections.add(copenhagen);
		...
		assetCollections.add(frankfurt);
		...
		assetCollections.add(fjStrauss);
